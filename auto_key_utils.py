...
util_submodule_l = ['clipboard_utils'] # list of all imports from local util_submodules that could be imported elsewhere to temporarily remove from sys.modules
...
from util_submodules.clipboard_utils import clipboard_utils as cu    ; util_submodule_import_check_count += 1 
